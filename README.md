...
* Your task is to use a Leaflet plugin (they can be found at <http://leafletjsF.com/plugins.html>) to visualize your earthquake as it takes place over a period of time.
